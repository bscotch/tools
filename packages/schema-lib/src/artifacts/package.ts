...
export type Package = Package1 & Package2;
 ...
 *
 * This interface was referenced by `Package2`'s JSON-Schema
...
export interface Package2 {
   ...
   *
   * This interface was referenced by `Package2`'s JSON-Schema definition
